...
import {
  fetchLeaveDocumentReducer,
  leaveApplicationReducer,
  leaveDropdownsReducer,
  leaveListReducer,
  returnDatesReducer,
  approveLeaveReducer,
  cancelLeaveReducer,
} from "../features/leaveApplication";
import {
  ApprovalReducer,
  CancelApprovalReducer,
  CommonSetupsReducer,
  DeleteLineReducer,
  DocumentsReducer,
} from "../features/common";
import {
  PurchasePlansSetupReducer,
  PurchaseRequisitionReducer,
} from "../features/purchaseRequisitions";
import { VehicleRequestReducer } from "../features/vehicleRequests";
import { TravelRequestReducer } from "../features/TravelRequest";
import {
  AdvanceRequisitionsReducer,
  AdvanceSurrenderReducer,
...
import LeaveApprovalReducer from "../features/approval-management/leavemgtFiles";
...
export const rootReducer = combineReducers({
  ...
  cancelLeave: cancelLeaveReducer,
  ...
  leaveApprovalMgt: LeaveApprovalReducer,
});
